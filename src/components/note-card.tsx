//importa tudo dentro do nome Dialog
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed inset-0 md:inset-auto md:left-1/2  md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden'>
                    ...
                    <button onClick={()=>props.onNoteDeleted(props.note.id)}
                        type='button'
